    ...
    <div>
      <div className="bg-slate-200 mx-auto my-0 max-w-lg h-full pb-8">
        ...
        "
          ...
          className="w-full"
        />
        <div className="fixed inset-x-0 top-[280px] sm:top-[376px] flex items-center justify-center">
        ...
        <div className="max-w-[80%] bg-white mx-auto pb-[115px]">
          ...
          <div className="flex items-center justify-center fixed bottom-32 right-12 sm:right-16 md:bottom-32 md:right-1/4 md:-translate-x-72 w-14 h-14 rounded-full bg-[#98694F] shadow-lg">
