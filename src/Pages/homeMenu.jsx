            ...
            return (
              <div id={items.nama_kategori_menu}>
                <div className="flex flex-row flex-wrap justify-center w-full mt-5">
                  <h1 className="ms-8 w-full font-bold" style={{ marginBottom: '-30px' }}>{items.nama_kategori_menu}</h1>
                  {
                    items.menu.map((menu) => {
                      return (
