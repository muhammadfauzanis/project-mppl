        ...
        <div className={` ${!isLoad && "hidden"}`}>
          <div className="bg-white py-[17px] px-4 rounded-sm">
            ...
            <div className="border-2 border-neutral-400 rounded-md p-3">
              ...
              <p className={`text-sm text-center mt-2 ${(listItem.jenis_pembayaran?.toUpperCase() !== "TUNAI" || listItem.status_pembayaran?.toUpperCase() !== "PENDING") && "hidden"} `}>* Tunjukkan pada nomor diatas pada kasir untuk pembayaran</p>
            ...
            <div className="mt-2 border-2 border-neutral-400 rounded-md p-3">
              ...
              <div className="flex justify-between">
                ...
                <p>{listItem.status_pembayaran?.toUpperCase()}</p>
              </div>
            </div>
