...
function AdminNavbar({children,page}) {	
			...
			<aside className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full lg:translate-x-0" aria-label="Sidebar">
				<div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
					...
					<ul className="space-y-2 font-medium" style={{lineHeight:2}}>
						<li>
							<Link to="/admin/dashboard" className={`flex items-center p-2 group rounded-lg ${page === "dashboard" ? "text-white bg-red-300 dark:text-white hover:bg-red-400 dark:hover:bg-gray-700" : "text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"}`}>
						...
						<li>
							<Link to="/admin/menu" className={`flex items-center p-2 group rounded-lg ${page === "menu" ? "text-white bg-red-300 dark:text-white hover:bg-red-400 dark:hover:bg-gray-700" : "text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"}`}>
								<svg className={`w-5 h-5 ${page === "" ? "text-white" : "text-gray-500"} transition duration-75 dark:text-gray-400 dark:group-hover:text-white`} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
									<path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z"/>
									<path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>
								</svg>
